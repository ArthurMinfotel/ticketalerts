...
(
    ...
    `entities_id`     int(11) NOT NULL default '0',
    `is_recursive`    tinyint(1) NOT NULL default '0',
    `group_criterion` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'OR',
    PRIMARY KEY (`id`),
    KEY               `entities_id` (`entities_id`)
...
(
    ...
    `is_recursive`                       tinyint(1) NOT NULL default '0',
    `rule_criterion`                     varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
    `rule_criterion_negation`            varchar(255) COLLATE utf8_unicode_ci DEFAULT 'AFFIRMATION',
    `group_criteria`                     varchar(255) COLLATE utf8_unicode_ci DEFAULT 'AFFIRMATION',
    `group_number`                       varchar(255) COLLATE utf8_unicode_ci DEFAULT '1',
    PRIMARY KEY (`id`),
